<template>
  <div class="flex flex-col justify-center items-center">
    ...
    <div class="form-control mb-5 w-full max-w-xs">
      ...
      <!-- Inputtan gelecek olan verilere todoText adını veriyorum. -->
      <input
        v-model="todoText"
        id="todoText"
        type="text"
    ...
    <div class="flex justify-center items-center">
      ...
      <button @click="clearAllHandler" class="btn btn-neutral">
        Clear Todos
      </button>
      <button
        @click="
...
export default {
  ...
  props: {
    // addItem fonksiyonunu kullanabilmek içi props olarak çekmemiz gerekiyor.
    addItem: {
      type: Function,
      required: true,
    },
